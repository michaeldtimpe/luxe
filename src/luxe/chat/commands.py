...
_HELP_ROWS: list[tuple[str, str, str]] = [
    ...
    ("/repair", "[--force]", "restart a stale local oMLX (brew replaced its tree) and wait for it"),
    ...
    ("/web", "", "toggle web tools: web_fetch (+render), web_search/web_answer, and the "
                 "interactive browser web_page (needs Chromium) — default off; `--web` at startup"),
