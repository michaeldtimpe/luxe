...
_SWEBENCH_TASK_PREFIX = (
    ...
    "5. Do NOT submit a final report with zero edits. Once you have "
    "located the bug and understood the fix, call edit_file BEFORE "
    "writing any final summary. A report without an edit is treated "
    "as a non-deliverable; analysis-only output does not satisfy this "
    "task.\n\n"
