...
Usage:
  python scripts/_archive/regrade_phase2.py
  python scripts/_archive/regrade_phase2.py --output acceptance/phase2
  python scripts/_archive/regrade_phase2.py --output acceptance/phase1   # also works on Phase 1
"""
