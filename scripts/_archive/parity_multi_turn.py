#!/usr/bin/env python3
"""scripts/_archive/parity_multi_turn.py — multi_turn BFCL Phase 3 parity gate.
...
RUN WITH THE STALE .venv PYTHON (it has bfcl_eval; MyEnv must NOT):
    .venv/bin/python -m scripts._archive.parity_multi_turn --pred acceptance/bfcl/mt_parity/rep_1/
