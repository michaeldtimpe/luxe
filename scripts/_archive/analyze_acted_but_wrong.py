...
Usage:
    .venv/bin/python -m scripts._archive.analyze_acted_but_wrong            # summary + manifest
    .venv/bin/python -m scripts._archive.analyze_acted_but_wrong --dump --bucket gt_value_mismatch --sample 20
