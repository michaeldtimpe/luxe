#!/usr/bin/env python3
"""scripts/_archive/variance_multi_turn.py — 3-rep variance for the multi_turn_base baseline.
...
substrate (like SWE-bench's strong/plausible tiers) or carries borderline noise.
    ...
    python -m scripts._archive.variance_multi_turn [--root acceptance/bfcl/multi_turn_base]
"""
