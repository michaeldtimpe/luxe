...
from cli.heuristic_router import FILE_HINT_RE
from cli.registry import AgentConfig, LuxeConfig
...
def route(
    ...
    *,
    ...
    if getattr(cfg, "heuristic_router_enabled", True):
        from cli.heuristic_router import decide as _heuristic_decide
