...
from luxe_cli import runner as _runner
from luxe_cli.registry import LuxeConfig
from luxe_cli.router import RouterDecision, route as _route
from luxe_cli.session import Session
from luxe_cli.tasks.cache import ToolCache
from luxe_cli.tasks.model import Subtask, Task, _now, append_log_event, persist
...
def _augment_with_trace_hints(
    ...
    *,
    ...
    if len(paths) < max_files:
        try:
            from luxe_cli.import_graph import build_graph as _build_graph
            from luxe_cli.import_graph import neighbors as _neighbors
